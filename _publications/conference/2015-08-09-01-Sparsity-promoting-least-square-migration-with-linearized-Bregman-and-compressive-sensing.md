...
date: 2015-08-09-01
venue: 'Sparsity-promoting least-square migration with linearized Bregman and compressive sensing'
citation: ' Philipp Witte,  Ning Tu,  Ernie Esser,  Mengmeng Yang,  Mathias Louboutin,  Felix Herrmann, &quot;Sparsity-promoting least-square migration with linearized Bregman and compressive sensing.&quot; Sparsity-promoting least-square migration with linearized Bregman and compressive sensing, 2015.'
---
(Natal, Brazil)

Use [Google Scholar](https://scholar.google.com/scholar?q=Sparsity+promoting+least+square+migration+with+linearized+Bregman+and+compressive+sensing){:target="_blank"} for full citation
